...
--
-- Хост: localhost
-- Время создания: Июн 10 2019 г., 07:26
...
(28, 'Тестовый', 'Покупатель', 'Покупатель', 'ТестГород', 'ТестУлица', 1, '123123', '79101231233', '2019-06-09');
...
(14, 17, 'Декорации для аквариумов', 'Альтернатера красная', 50, 'Многолетнее травянистое растение, опушенное у основания. Альтернантера Бетцика теплолюбива; температуру ниже 18°С не переносит.\nЛистья красивого красного оттенка.\nКогда у растения начнут опадать листья, его следует заменить новыми.\nВ аквариумных условиях растения нуждаются в хорошем освещении и слабокислой воде.');
...
(15, 'Аква-деко', 'Россия', 'Белгород', 'Есенина 21', '79157777346');
...
--
ALTER TABLE `buyer`
  MODIFY `Buyer_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `product_buyer`
  MODIFY `proudct_buyer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT для таблицы `supplyer`
--
ALTER TABLE `supplyer`
  MODIFY `Supplyer_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT для таблицы `waybill`
--
ALTER TABLE `waybill`
  MODIFY `Waybill_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
