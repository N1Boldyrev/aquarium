...
--
-- Хост: localhost
-- Время создания: Июн 21 2019 г., 00:20
...
--
ALTER TABLE `supplyer`
  MODIFY `Supplyer_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT для таблицы `waybill`
--
ALTER TABLE `waybill`
  MODIFY `Waybill_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `waybill`
  ADD CONSTRAINT `my_fk` FOREIGN KEY (`Supplyer_ID`) REFERENCES `supplyer` (`Supplyer_ID`);
COMMIT;
